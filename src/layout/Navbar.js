...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`navbar ${showNavList && !isLargeScreen ? "h-[115px]" : "h-[70px]"} backdrop-blur-xl md:backdrop-blur-none fixed top-0 w-full px-4 md:px-12 py-3 text-white ${!isLargeScreen && "ddd"}`}
        style={{
          zIndex: 9999999,
              ...
              {isOpen && (
                <div className="bg-black/95 absolute z-50 right-0 top-10 min-w-[170px] pt-2 border border-gray-900 rounded-md">
                  ...
                  >
                    ...
                    <div className="title">Anshita</div>
                  </a>
                  <a
                    href="#!"
                    className="flex items-center px-4 py-2 gap-3 text-xs text-slate-500 hover:text-white"
